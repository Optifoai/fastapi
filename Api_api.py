from fastapi import FastAPI, File, UploadFile, Response,BackgroundTasks, Form,HTTPException
...
async def generate_reel(car_request: CarRequest):
    ...
    """
    try:
        result = process_car_reel(car_request.image_urls, car_request.text_data)
        return result
